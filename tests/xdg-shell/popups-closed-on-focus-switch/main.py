...
# This test opens text editor and a gtk keyboard logger client side by side.
# Then, it opens a menu in the text editor (xdg-popup) which should be automatically closed when clicking on the gtk logger client.
class WTest(wt.WayfireTest):
    ...
    def _run(self):
        ...
        gtk = wu.LoggedProcess(self.socket, 'gtk_logger', 'gtk2', 'keyboard pointer')
        ...
        self.wait_for_clients_to_open(nr_clients=3, message='Popup menu did not open!')
