...
wf::ipc::server_t::server_t(std::string socket_path)
{
    ...
    listen(fd, 3);
    source = wl_event_loop_add_fd(wl_display_get_event_loop(wf::get_core().display), fd,
...
nlohmann::json wf::ipc::server_t::call_method(std::string method, nlohmann::json data)
{
